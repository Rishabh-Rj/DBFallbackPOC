...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDto createEmployee(EmployeeDto employeeDto) {
        ...
        logger.info("Kafka event sent: id={}, firstName={}, lastName={}, email={}", event.getId(), event.getFirstName(), event.getLastName(), event.getEmail());
        streamBridge.send("employeeEvent-out-0", event);
        return result;
    }
